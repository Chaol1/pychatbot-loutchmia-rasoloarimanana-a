...
Le fichier menu_all.py est notre fichier principal. Il propose à l'utilisateur un menu avec 2 options.
...
from chatbot_officiel_loutchmia_rasoloarimanana import *
import time
